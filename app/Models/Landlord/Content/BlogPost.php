...
use Database\Factories\Landlord\Content\BlogPostFactory;
...
class BlogPost extends Model implements HasMedia
{
    ...
    use CentralConnection, HasFactory, HasLandlordSeo, HasSlug, InteractsWithMedia;

    /**
     * @var string
     */
    protected $table = 'landlord_blog_posts';
