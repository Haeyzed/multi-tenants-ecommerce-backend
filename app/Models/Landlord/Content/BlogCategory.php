...
use Database\Factories\Landlord\Content\BlogCategoryFactory;
...
class BlogCategory extends Model
{
    ...
    use CentralConnection, HasFactory, HasSlug;

    /**
     * @var string
     */
    protected $table = 'landlord_blog_categories';
