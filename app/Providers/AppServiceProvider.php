...
use App\Policies\Tenant\InterviewMeetingPolicy;
use App\Policies\Tenant\InterviewPolicy;
use App\Policies\Tenant\InventoryPolicy;
use App\Policies\Tenant\InvoicePolicy;
use App\Policies\Tenant\JobApplicationPolicy;
use App\Policies\Tenant\JobOfferPolicy;
use App\Policies\Tenant\JobOpeningPolicy;
...
use App\Policies\Tenant\PerformanceCyclePolicy;
use App\Policies\Tenant\PerformanceReviewPolicy;
...
use App\Policies\Tenant\RecruitmentStagePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(RecruitmentStage::class, RecruitmentStagePolicy::class);
        Gate::policy(Interview::class, InterviewPolicy::class);
        Gate::policy(InterviewMeeting::class, InterviewMeetingPolicy::class);
