...
use App\Http\Requests\Landlord\Notification\IndexInboxRequest;
use App\Http\Resources\Landlord\Notification\InboxNotificationResource;
...
/**
 * Landlord authenticated user notification inbox.
 */
