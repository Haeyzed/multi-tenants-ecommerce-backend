...
class CommerceSettingService
{
    ...
    public const array DOMAINS = [
        ...
        'hr' => [
            ...
            'hr.payroll.tax_payable_account_id' => ['type' => 'nullable_int', 'default' => null],
            'hr.payroll.deduction_payable_account_id' => ['type' => 'nullable_int', 'default' => null],
            'hr.payroll.tax_enabled' => ['type' => 'bool', 'default' => false],
            'hr.payroll.tax_table_id' => ['type' => 'nullable_int', 'default' => null],
            'hr.payroll.tax_ytd_enabled' => ['type' => 'bool', 'default' => false],
            'hr.payroll.tax_year_start_month' => ['type' => 'int', 'default' => 1],
            'hr.payroll.pension_enabled' => ['type' => 'bool', 'default' => false],
            'hr.payroll.pension_employee_percent' => ['type' => 'money', 'default' => '8.00'],
            'hr.payroll.pension_employer_percent' => ['type' => 'money', 'default' => '10.00'],
            'hr.payroll.nhf_enabled' => ['type' => 'bool', 'default' => false],
            'hr.payroll.nhf_percent' => ['type' => 'money', 'default' => '2.50'],
            'hr.payroll.nsitf_enabled' => ['type' => 'bool', 'default' => false],
            'hr.payroll.nsitf_percent' => ['type' => 'money', 'default' => '1.00'],
            'hr.payroll.nibss.enabled' => ['type' => 'bool', 'default' => false],
            'hr.payroll.nibss.base_url' => ['type' => 'nullable_string', 'default' => null],
            'hr.payroll.nibss.api_key' => ['type' => 'nullable_string', 'default' => null],
            'hr.payroll.nibss.institution_code' => ['type' => 'nullable_string', 'default' => null],
            'hr.payroll.nibss.originator_account' => ['type' => 'nullable_string', 'default' => null],
            'hr.payroll.nibss.originator_bank_code' => ['type' => 'nullable_string', 'default' => null],
            'hr.overtime.enabled' => ['type' => 'bool', 'default' => false],
            'hr.overtime.rate_percent' => ['type' => 'int', 'default' => 150],
            'hr.overtime.weekly_enabled' => ['type' => 'bool', 'default' => false],
            'hr.overtime.weekly_threshold_minutes' => ['type' => 'int', 'default' => 2400],
            'hr.overtime.weekly_rate_percent' => ['type' => 'int', 'default' => 150],
            'hr.working_hours_per_day' => ['type' => 'int', 'default' => 8],
            'hr.attendance.gps_required' => ['type' => 'bool', 'default' => false],
            'hr.attendance.geofence_latitude' => ['type' => 'nullable_string', 'default' => null],
            'hr.attendance.geofence_longitude' => ['type' => 'nullable_string', 'default' => null],
